...
public class ServiceRank {
    ...
    private static ArrayList<String> load_input_file(String input) {
    ...
    private static String get_ranked_service_list_str(ArrayList<Service> services) {
        String output = "";
        ...
        for(Service s: services) {
            ...
            output += (s.phone + "|");
            output += (s.opening_time + "|");
            output += (s.closing_time + "|");
            output += (s.distance_from_user_in_miles + " miles@");
        }
    ...
    public static String just_rank(String input) {
        //Loading user generated info in input file:
        ArrayList<String> input_file        = load_input_file(input);
        ...
        //Sorting service list by closest to furthest from user:
        Collections.sort(services, new SortByDistance());

        //Writing sorted service list to output file:
        return get_ranked_service_list_str(services);
    }
}
